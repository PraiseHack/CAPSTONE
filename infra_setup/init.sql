...
FROM '/data/olist_customers_dataset.csv' WITH (
    FORMAT CSV,
    HEADER TRUE,
    DELIMITER ','
);
...
FROM '/data/olist_geolocation_dataset.csv' WITH (
    FORMAT CSV,
    HEADER TRUE,
    DELIMITER ','
);
...
FROM '/data/olist_order_items_dataset.csv' WITH (
    FORMAT CSV,
    HEADER TRUE,
    DELIMITER ','
);
...
FROM '/data/olist_order_payments_dataset.csv' WITH (
    FORMAT CSV,
    HEADER TRUE,
    DELIMITER ','
);
...
FROM '/data/olist_order_reviews_dataset.csv' WITH(
    FORMAT CSV,
    HEADER TRUE,
    DELIMITER ','
);
...
FROM '/data/olist_orders_dataset.csv' WITH (
    FORMAT CSV,
    HEADER TRUE,
    DELIMITER ','
);
...
FROM '/data/olist_products_dataset.csv' WITH (
    FORMAT CSV,
    HEADER TRUE,
    DELIMITER ','
);
...
FROM '/data/olist_sellers_dataset.csv' WITH (
    FORMAT CSV,
    HEADER TRUE,
    DELIMITER ','
);
...
FROM '/data/product_category_name_translation.csv' WITH (
    FORMAT CSV,
    HEADER TRUE,
    DELIMITER ','
);
